...
<div class="container">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h1>App</h1></div>
                    <div class="card-body">
                        <form action="{{ url("/admin/configs/$configs->id") }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group float-right">
                                        <a href="{{ route('dashboard') }}" class="btn btn-light me-2">Back</a>
